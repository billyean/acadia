...
| Randomize Collection                                                                     | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/RandomizedCollection.java)<br>~~`Test`~~||||||||
| Reduce Array Size to Half                                                                | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/ReduceArraySize2Half.java)<br>~~`Test`~~||||||||
| Sum Subarray Minimums                                                                    | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/SumSubarrayMinimums.java)<br>~~`Test`~~||||||||
| Find All Duplicates in an Array                                                          | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/FindAllDuplicatesArray.java)<br>~~`Test`~~||||||||
| Check If All 1's Are at Least Length K Places Away                                       | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/KLengthApart.java)<br>~~`Test`~~||||||||
| Number of Sub-arrays of Size K and Average Greater than or Equal to Threshold            | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/NumOfSubarrays.java)<br>~~`Test`~~||||||||
| Unique Paths II                                                                          | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/UniquePaths.java)<br>~~`Test`~~||||||||
| Array of Doubled Pairs                                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/ArrayOfDoubledPairs.java)<br>~~`Test`~~||||||||
| Get Equal Substrings Within Budget                                                       | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/GetEqualSubstringsWithinBudget.java)<br>~~`Test`~~||||||||
| Maximum Points You Can Obtain from Cards                                                 | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/MaximumPointsObtainCards.java)<br>~~`Test`~~||||||||
| Count Servers that Communicate                                                           | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CountServersCommunicate.java)<br>~~`Test`~~||||||||
| Longest Turbulent Subarray                                                               | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/LongestTurbulentSubarray.java)<br>~~`Test`~~||||||||
| Queries on a Permutation With Key                                                        | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/QueriesPermutationWithKey.java)<br>~~`Test`~~||||||||
| Count Number of Teams                                                                    | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CountNumberOfTeams.java)<br>~~`Test`~~||||||||
| Cinema Seat Allocation                                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CinemaSeatAllocation.java)<br>~~`Test`~~||||||||
| Friends Of Appropriate Ages                                                              | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/FriendsOfAppropriateAges.java)<br>~~`Test`~~||||||||
| Global and Local Inversions                                                              | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/GlobalLocalInversions.java)<br>~~`Test`~~||||||||
| Sum of Mutated Array Closest to Target                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/SumOfMutatedArrayClosestToTarget.java)<br>~~`Test`~~||||||||
| Lonely Pixel I                                                                           | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/LonelyPixel.java)<br>~~`Test`~~||||||||
| Construct Binary Tree from Inorder and Postorder Traversal                               | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/ConstructBinaryTree.java)<br>~~`Test`~~||||||||
| Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit               | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/LongestContinuousSubarray.java)<br>~~`Test`~~||||||||
| Subarray Sum Equals K                                                                    | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/SubarraySumEqualsK.java)<br>~~`Test`~~||||||||
| Maximum Sum Circular Subarray                                                            | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/MaximumSumCircularSubarray.java)<br>~~`Test`~~||||||||
| Divide Array in Sets of K Consecutive Numbers                                            | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/DivideArrayKConsecutiveNumbers.java)<br>~~`Test`~~||||||||
| Grumpy Bookstore Owner                                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/GrumpyBookstoreOwner.java)<br>~~`Test`~~||||||||
| Corporate Flight Bookings                                                                | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CorporateFlightBookings.java)<br>~~`Test`~~||||||||
| Queens That Can Attack the King                                                          | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/QueensCanAttackKing.java)<br>~~`Test`~~||||||||
| Remove Sub-Folders from the Filesystem                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/RemoveSubFolders.java)<br>~~`Test`~~||||||||
| Uncrossed Lines                                                                          | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/UncrossedLines.java)<br>~~`Test`~~||||||||
| Longest Line of Consecutive One in Matrix                                                | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/LongestLineConsecutiveOneInMatrix.java)<br>~~`Test`~~||||||||
| Split Array with Equal Sum                                                               | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/SplitArrayWithEqualSum.java)<br>~~`Test`~~||||||||
| Teemo Attacking                                                                          | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/TeemoAttacking.java)<br>~~`Test`~~||||||||
| Number of Subarrays with Bounded Maximum                                                 | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/NumberOfSubarraysWithBoundedMaximum.java)<br>~~`Test`~~||||||||
| Minimum Increment to Make Array Unique                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/MinimumIncrement2MakeArrayUnique.java)<br>~~`Test`~~||||||||
| Leftmost Column with at Least a One                                                      | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/LeftmostColumnWithAtLeastAOne.java)<br>~~`Test`~~||||||||
| Previous Permutation With One Swap                                                       | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/PreviousPermutationWithOneSwap.java)<br>~~`Test`~~||||||||
| Decrease Elements To Make Array Zigzag                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/DecreaseElementsToMakeArrayZigzag.java)<br>~~`Test`~~||||||||
| Count Square Submatrices with All Ones                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CountSquareSubmatriceswithAllOnes.java)<br>~~`Test`~~||||||||
| Sort the Matrix Diagonally                                                               | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/SortMatrixDiagonally.java)<br>~~`Test`~~||||||||
| Subrectangle Queries                                                                     | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/SubrectangleQueries.java)<br>~~`Test`~~||||||||
| Reveal Cards In Increasing Order                                                         | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/RevealCardsInIncreasingOrder.java)<br>~~`Test`~~||||||||
| Task Scheduler                                                                           | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/TaskScheduler.java)<br>~~`Test`~~||||||||
| Count Triplets That Can Form Two Arrays of Equal XOR                                     | Medium     [`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/EqualXOR.java)<br>~~`Test`~~||||||||
| Array Nesting                                                                            | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/ArrayNesting.java)<br>~~`Test`~~||||||||
| Shortest Word Distance III                                                               | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/ShortestWordDistance.java)<br>~~`Test`~~||||||||
| Maximum Sum of Two Non-Overlapping Subarrays                                             | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/MaximumSumTwoNonOverlappingSubarrays.java)<br>~~`Test`~~||||||||
| Filter Restaurants by Vegan-Friendly, Price and Distance                                 | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/FilterRestaurants.java)<br>~~`Test`~~||||||||
| Beautiful Arrangement II                                                                 | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/BeautifulArrangement.java)<br>~~`Test`~~||||||||
| Capacity To Ship Packages Within D Days                                                  | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CapacityToShipPackagesWithinDDays.java)<br>~~`Test`~~||||||||
| Best Sightseeing Pair                                                                    | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/BestSightseeingPair.java)<br>~~`Test`~~||||||||
| Minimum Domino Rotations For Equal Row                                                   | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/MinimumDominoRotationsForEqualRow.java)<br>~~`Test`~~||||||||
| Number of Matching Subsequences                                                          | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/NumberOfMatchingSubsequences.java)<br>~~`Test`~~||||||||
| Candy Crush                                                                              | Medium     |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CandyCrush.java)<br>~~`Test`~~||||||||
| Combination Sum [II](https://leetcode.com/problems/combination-sum-ii/) [III](https://leetcode.com/problems/combination-sum-iii/)| Medium |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/array/CandyCrush.java)<br>~~`Test`~~||||||||
