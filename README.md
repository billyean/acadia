...
|`Problem                                     List`|` Java        `|`Python`|`  C++  `|` Swift `|` JavaScript `|` Scala `|`    Go    `|
|--------------------------------------------------|---------------|--------|---------|---------|--------------|---------|------------|
| Zigzag Conversion                                |[Solution](java/src/main/java/com/haibo/yan/algorithm/array/Zigzag.java)|[Solution](python/array/zigzag.py)||[Solution](swift/array/Zigzag.swift)||[Solution](scala/src/main/scala/com/haiboyan/scala/algorithm/array/Zigzag.scala)||
| Remove duplicates int from array                 |[Solution](java/src/main/java/com/haibo/yan/algorithm/array/RemoveDuplicates.java)|||||[Solution](scala/src/main/scala/com/haiboyan/scala/algorithm/array/RemoveDuplicates.scala)|[Solution](go/src/array/zigzag.go)|
