...
| Valid Anagram                                             |[`Solution`](java/src/main/java/com/haibo/yan/algorithm/ValidAnagram.java)<br>[`Test`](java/src/test/java/com/haibo/yan/algorithm/TestValidAnagram.java)|[`Solution`](python/misc/valid_anagram.py)<br>[`Test`](python/test/misc/test_anagram.py)|[`Solution`](c++/algorithm/misc/Anagram.cpp)<br>~~`Test`~~|||[`Solution`](scala/src/main/scala/com/haiboyan/scala/algorithm/array/Anagram.scala)<br>[`Test`](scala/src/test/scala/com/haiboyan/scala/algorithm/array/AnagramTest.scala)|[`Solution`](go/src/miscellaneous/anagram.go)<br>[`Test`](go/test/miscellaneous/anagram_test.go)|
