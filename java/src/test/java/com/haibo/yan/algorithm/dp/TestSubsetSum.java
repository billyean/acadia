...
public class TestSubsetSum {
    ...
    public Object[][] testObjects() {
        return new Object[][] {
                {11, new int[]{1, 3, 4, 8, 10}, true} ,
                {14, new int[]{1, 3, 4, 8, 10}, true},
                {16, new int[]{1, 3, 4, 8, 10}, true},
                {20, new int[]{1, 3, 4, 8, 10}, false}
        };
    }
    @Test(dataProvider = "testObjects")
    public void test(int sum, int[] array, boolean expected) {
