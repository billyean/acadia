...
func TestPrintPattern0(t *testing.T) {
	...
	if actual != nil {
		t.Errorf("PrintPattern(0) expects empty array but got %s.", actual)
	}
}
...
func TestPrintPattern1(t *testing.T) {
	...
	if !reflect.DeepEqual(actual, [][]int{{1}}) {
		t.Errorf("PrintPattern(1) expects {{1}} array but got %s.", actual)
	}
}
...
func TestPrintPattern4(t *testing.T) {
	...
	if !reflect.DeepEqual(actual, [][]int{{1}, {1, 1}, {2, 1}, {1, 2, 1, 1}}) {
		t.Errorf("PrintPattern(4) expects {{1}, {1, 1}, {2, 1}, {1, 2, 1, 1}} array but got %s.", actual)
	}
}
...
func TestPrintPattern8(t *testing.T) {
	...
	if !reflect.DeepEqual(actual, [][]int{{1}, {1, 1}, {2, 1}, {1, 2, 1, 1}, {1, 1, 1, 2, 2, 1}, {3, 1, 2, 2, 1, 1}, {1, 3, 1, 1, 2, 2, 2, 1}, {1, 1, 1, 3, 2, 1, 3, 2, 1, 1}}) {
		t.Errorf("PrintPattern(8) expects {{1}, {1, 1}, {2, 1}, {1, 2, 1, 1}, {1, 1, 1, 2, 2, 1}, {3, 1, 2, 2, 1, 1}, {1, 3, 1, 1, 2, 2, 2, 1}, {1, 1, 1, 3, 2, 1, 3, 2, 1, 1}} array but got %s.", actual)
	}
}